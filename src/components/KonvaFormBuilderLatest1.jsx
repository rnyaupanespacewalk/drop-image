...
// ─── Shared: render a single form field ──────────────────────────────────────
...
// ─── Accordion section for one container ─────────────────────────────────────
...
function PreviewForm({ freeElements, containers, onClose }) {
  ...
  // All field elements (no buttons/labels for validation)
        ...
        <div style={{ padding: "20px 24px 24px" }}>
          {result ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {/* ── Free elements (flat, no accordion) ── */}
              ...
              {/* ── Container accordion sections ── */}
              {containers.map((cont, idx) => {
                const contErrors = cont.children.some((ch) => errors[ch.id]);
                const hasButton = cont.children.some(
                  (ch) => ch.type === "Button",
                );
                return (
                  <AccordionSection
              ...
              {/* Default submit if no Button element exists anywhere */}
...
// ─── App ──────────────────────────────────────────────────────────────────────
export default function KeplerBuilderLatest1() {
  ...
  // Total element count for top bar
  const totalElements =
